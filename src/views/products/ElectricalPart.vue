...
const pageTitle = "Electrical Part"
const pageDescription = "Explosion-proof Electrical Parts"
const vendors = [
  {
    "name": "Supermec",
    "category": "Explosion-proof Electrical Parts",
    "items": "Junction Box (J/B)\nTerminal Box (T/B)\nLighting\nCable & Gland",
    "website": "https://www.supermec.com"
  }
]
</script>
